...
function clk()
{
    ...
    am_pm="PM"
     ...
     {
        case 0:dy="Sunday"
        bdy.style.backgroundImage="url(./sunday.png)"
        break;
        case 1:dy="Monday"
...
function greet()
{
   var date=new Date()
    ...
    if(time>=5 && time<=12)
    {
        ...
        document.getElementById("vid").src="./goodmorningvid.mp4"
        document.getElementById("container").style.backgroundColor="rgba(0,0,0,0.57)"
        document.getElementById("Time").style.color="black"
        document.getElementById("Date").innerHTML="darkblue"
    ...
    else if(time>=12 && time<=16)
    {
      ...
      document.getElementById("vid").src="./goodaftervid.mp4"
    }
    else if(time>=16 && time<=20)
    {
      document.getElementById("message").innerHTML="Good Evening"
      document.getElementById("vid").src="./goodeveningvid.mp4"
      document.getElementById("container").style.backgroundColor="rgba(0,0,00.57)"
      ...
      document.getElementById("sec").style.color="black"
         ...
         document.getElementById("vid").src="./goodnightvid.mp4"
      document.getElementById("container").style.backgroundColor="rgba(0,0,00.57)"
      document.getElementById("Time").style.color="white"
      document.getElementById("Date").style.color="wheat"
      document.getElementById("Day").style.color="wheat"
